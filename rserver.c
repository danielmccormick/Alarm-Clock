...
void displayTime(struct nice_time *time) {
...
int adjustTime(struct nice_time *time, int difference) { // hopefully th
...
void alarm_trigger(struct nice_time *alarm) {
